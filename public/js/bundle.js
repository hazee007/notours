...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGF6ZWUwMDciLCJhIjoiY2tiMjd4Y2k2MDc2cjJyczN2aG1mNHFsYiJ9.T5aXc3sNTXntRZ903rpWjA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hazee007/ckb28ox7f0yiq1iqdzuq2115r',
    scrollZoom: false //   center: [-118.11349, 34.111745],
    //   zoom: 4,
...
var stripe = Stripe('pk_test_51GszegBLB2NpxxhVwsHbv1XsW04eBILb1FzbSL2kDMMfMFZm7qvzrz5Meu5YFKZxtt3DKOEkFdWjWtbolj9MVaAk00h0OksVGk');
...
var updatePassBtn = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); // VALES
// DELEGATion
...
if (updatePassBtn) updatePassBtn.addEventListener('submit', /*#__PURE__*/function () {
